...
.. tab-set::
    ...
    .. tab-item:: Latest Release
        ...
        .. code-block:: shell
          ...
          pip install "skypilot[aliyun]"
          pip install "skypilot[tencent]"
          pip install "skypilot[volcengine]"
          pip install "skypilot[spheron]"
          pip install "skypilot[digitalocean]"
    ...
    .. tab-item:: Nightly
        ...
        .. code-block:: shell
          ...
          pip install "skypilot-nightly[aliyun]"
          pip install "skypilot-nightly[tencent]"
          pip install "skypilot-nightly[volcengine]"
          pip install "skypilot-nightly[spheron]"
          pip install "skypilot-nightly[digitalocean]"
