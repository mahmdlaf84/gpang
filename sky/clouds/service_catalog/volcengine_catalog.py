"""Static catalog for Volcengine resources."""
...
_DATA = [
    ...
    },
    {
        ...
        'AcceleratorName': 'A10',
        'AcceleratorCount': 1,
        'AcceleratorMemoryGiB': 24.0,
        'GpuInfo': '{"Gpus": [{"Name": "NVIDIA A10", "MemoryInfo": {"SizeInMiB": 24576}}]}',
        'vCPUs': 16,
        'MemoryGiB': 64.0,
        'Price': 2.60,
        'SpotPrice': 1.56,
...
def validate_region_zone(region: Optional[str],
    ...
    if zone is not None:
        with ux_utils.print_exception_no_traceback():
            raise ValueError('Volcengine catalog does not expose zones.')
    return common.validate_region_zone_impl('volcengine', _get_df(), region, zone)
...
def list_accelerators(
    ...
    return common.list_accelerators_impl('Volcengine', _get_df(), gpus_only,
