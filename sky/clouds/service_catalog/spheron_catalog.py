"""Static catalog for Spheron Network resources."""
...
def validate_region_zone(region: Optional[str],
    ...
    if zone is not None:
        with ux_utils.print_exception_no_traceback():
            raise ValueError('Spheron catalog does not expose zones.')
...
def regions() -> List['cloud.Region']:
    return common.regions_impl('spheron', _get_df())
